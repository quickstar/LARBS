...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/quickstar/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/quickstar/LARBS/master/progs.csv"
